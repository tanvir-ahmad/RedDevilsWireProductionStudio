...
// The Windows High-Contrast theme is enabled if this value is 0.
// This is not a formal Microsoft API, but it's a known workaround.
...
// Scale helper for high-DPI scaling.
int Scale(int value, double scale_factor) {
  return static_cast<int>(value * scale_factor);
}

// Dynamically loads the |EnableNonClientDpiScaling| function from User32.dll if
// available.
